...
var host = new HostBuilder()
    ...
    .ConfigureServices((ctx, services) =>
    {
        ...
        services.AddSingleton<INotificationStore>(sp =>
        {
            var opts = sp.GetRequiredService<IOptions<ArchiveOptions>>().Value;
            var cosmos = sp.GetRequiredService<CosmosClient>();
            return new CosmosNotificationStore(cosmos.GetContainer(opts.CosmosDatabase, opts.CosmosNotificationsContainer));
        });
